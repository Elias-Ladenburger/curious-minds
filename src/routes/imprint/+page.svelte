<script>
    ...
    function showMail() {
        myMail = "<a href='mailto:curiousminds@eliasladenburger.com'>curiousminds@eliasladenburger.com</a>"
    }
</script>
...
<div id="imprint" class="mx-5 text-primaryContrast text-sm">
    ...
    <p>As service provider, we are liable for all contents of this website according to Paragraph 7, Sect. 1 German Telemedia Act (TMG). 
    ...
    <p>Legal obligations to removing information or to blocking the use of information remain unchallenged. 
        ...
        Illegal contents will be removed immediately at the time that we receive knowledge of them.
</p>
...
<p>
    ...
    Illegal links will be removed immediately at the time that we receive knowledge of them.
</p>
